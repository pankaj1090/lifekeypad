                ...
                <div class="panel panel-default">
                    ...
                    <div id="accordion4" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="one">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6">
                            <input type="file" class="form-control add_cate_form" name="cateimage">
                            <?php if(!empty($solocate)) {
                            echo '<img src="'.$basepath.'repo/categories/'.$solocate[0]['cate_image'].'"  style="width: 100px;"/><br/>';
                            echo '<span class="input_help_info">New upload will replace the old one.</span>';
                            } ?>
    ...
    $getProducts = $this->DatabaseModel->access_database('ts_products','select','',$whr_array);
						    ?>
									<tr>
										...
										<td><?php echo '<img src="'.$basepath.'repo/categories/'.$solocate['cate_image'].'" style="width: 100px;"/>';?></td>
