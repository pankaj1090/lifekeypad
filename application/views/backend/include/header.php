			...
			<ul>
				...
				<li><a>Products</a>
				    <ul>
				        ...
				        <li><a href="<?php echo $basepath;?>backend/language_section">Languages</a></li>
			...
			<div class="col-lg-4 col-md-4 col-sm-3 logo_section">
				...
				<div class="th_user_login">
					...
					<div class="user_login_detail">
						<h5 class="user_name"><a>Hi,<span style="color: white;"><?php echo $this->session->userdata['ts_uname']; ?></span></a></h5>
