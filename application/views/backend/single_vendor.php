							...
							<div class="th_manage_user">
								...
								<div class="user_product_info">
									...
									<ul class="nav nav-tabs theme_tab" role="tablist">
										<li role="presentation" class="active"><a href="#info" aria-controls="info" role="tab" data-toggle="tab" style="color:#fff;">Profile</a></li>
										<li role="presentation"><a href="#product_purchase" aria-controls="product_purchase" role="tab" data-toggle="tab" style="color:#fff;">Purchase detail</a></li>
										<li role="presentation"><a href="#product_upload" aria-controls="product_upload" role="tab" data-toggle="tab" style="color:#fff;">Products</a></li>
										<li role="presentation"><a href="#earning_section" aria-controls="earning_section" role="tab" data-toggle="tab" style="color:#fff;">Earnings</a></li>
										<li role="presentation"><a href="#withdrawal_section" aria-controls="withdrawal_section" role="tab" data-toggle="tab" style="color:#fff;">Make a Payment</a></li>
										<li role="presentation"><a href="#payment_history_section" aria-controls="payment_history_section" role="tab" data-toggle="tab" style="color:#fff;">Payment History</a></li>
									</ul>
