				...
				<form class="form-inline" action="<?php echo $basepath;?>home/search_products" method="post">
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
						<div class="form-group">
							<select class="form-control" name="language" onchange="getSubCategoriesbylanguage(this)">
								<option value="0">Languages</option>

								<?php
									 foreach($languageList as $soloLanguage) {
									 	$selected='';
								         if( isset($_POST['language']) ) {
											$selected = ($_POST['language'] == $soloLanguage['lancate_name']) ? 'selected' : '' ;
										}
										echo '<option value="'.$soloLanguage['lancate_name'].'" '.$selected.'>'.$soloLanguage['lancate_name'].'</option>';
									  } ?>
							</select>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-3 col-xs-12">
						<div class="lk_small_field">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="Price From" value="">
							</div>
						</div>
						<div class="lk_small_field">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="Price To" value="">
							</div>
						</div>
						<!--<div class="lk_btndiv">
