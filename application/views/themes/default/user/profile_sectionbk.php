    ...
    <?php if( isset($this->session->userdata['ts_uid']) ) { ?>
     <?php if($this->session->userdata['ts_uid']==$userDetail[0]['user_id']){ ?>
        <div class="lk_cp_menu">
            <a onclick="open_create_post()"><svg version="1.1" x="0px" y="0px" width="25px" height="23.999px" viewBox="0 0 25 23.999" enable-background="new 0 0 25 23.999" xml:space="preserve"><g><g><path fill="#FFFFFF" d="M23.888,15.479c-0.614,0-1.112,0.496-1.112,1.108v3.782c0,0.779-0.636,1.413-1.418,1.413H3.643c-0.782,0-1.419-0.634-1.419-1.413v-3.782c0-0.612-0.498-1.108-1.111-1.108C0.498,15.479,0,15.976,0,16.588v3.782c0,2,1.634,3.629,3.643,3.629h17.715c2.009,0,3.643-1.629,3.643-3.629v-3.782C25,15.976,24.502,15.479,23.888,15.479z M8.225,6.934l3.163-3.151v14.973c0,0.612,0.498,1.108,1.112,1.108s1.112-0.496,1.112-1.108V3.783l3.162,3.15c0.217,0.216,0.502,0.324,0.787,0.324c0.284,0,0.568-0.108,0.786-0.324c0.435-0.433,0.435-1.134,0-1.567l-5.06-5.041c-0.103-0.103-0.226-0.184-0.363-0.241c-0.272-0.112-0.579-0.112-0.85,0c-0.137,0.057-0.26,0.138-0.362,0.241l-5.06,5.041c-0.435,0.433-0.435,1.134,0,1.567S7.791,7.366,8.225,6.934z"/></g></g></svg> Update Post</a>
					 ...
					 $imgsrc=base_url().'webimage/'.$userDetail[0]['user_pic'];
                        ...
                        <div class="lk_cp_detail">
                            ...
                            <div class="lk_cp_meta">
                                <ul>
                                    <li><?php echo  $this->my_model->aggregate_data('ts_posts','	post_id','count',array('post_uid'=>$userDetail[0]['user_id'])) ?> Posts</li>
