	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="lk_manage_product table-responsive">
					<table class="commonTable table table-striped table-bordered manage_user">
					<thead>
								<tr>
									<th>#</th>
					...
					<tbody>
								...
								<?php if($this->session->userdata['ts_level'] == 1) {
								    if( $soloprod['prod_uid'] == '1' ) {
								        echo '<td style="color:#A8C937;font-weight:bold;">Admin</td>';
								    }
								    else {
									...
									<?php } else { ?>
									<td>
									    <?php echo ($soloprod['prod_status'] == '1') ? '<span class="lk_green">'.$this->ts_functions->getlanguage('activetext','vendorboard','solo').'</span>' : '<span class="lk_red">'.$this->ts_functions->getlanguage('inactivetext','vendorboard','solo').'</span>' ; ?>
									</td>
									<?php } ?>
									...
									<?php } else { ?>
									<td>
									    <?php echo ($soloprod['prod_featured'] == '1') ? '<span class="lk_green">'.$this->ts_functions->getlanguage('yestext','vendorboard','solo').'</span>' : '<span class="lk_red">'.$this->ts_functions->getlanguage('notext','vendorboard','solo').'</span>' ; ?>
									</td>
									<?php } ?>
									...
									<?php if( $soloprod['prod_image'] != '' ) { ?>
										<td><span class="lk_green"><?php echo $this->ts_functions->getlanguage('yestext','vendorboard','solo');?></span></td>
									<?php } else { ?>
										<td><span class="lk_red"><?php echo $this->ts_functions->getlanguage('notext','vendorboard','solo');?></span></td>
									<?php } ?>
