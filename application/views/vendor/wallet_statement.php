	...
	<div class="container">
		<div class="row">
			...
			<?php $currentWallet = $this->DatabaseModel->access_database('ts_wallet','select','',array('wallet_uid'=>$this->session->userdata['ts_uid']));
							...
							?>
								<h3 class="th_title"><?php echo $this->ts_functions->getlanguage('walletmenu','vendorboard','solo');?> ( <?php echo $this->ts_functions->getlanguage('blncamnttext','vendorboard','solo');?> : <b style="color:#A8C937;"><?php echo $this->ts_functions->getsettings('portal','curreny').' <span id="totEarning">'.$wallet_amount.'</span>';?></b>) </h3>
